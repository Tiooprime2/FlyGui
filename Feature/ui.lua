...
-- TIOO Fly - GUI
-- by Tiooprime2
-- Cara pakai: require/loadstring lalu panggil UI.init(Fly)
-- =========================================================
...
-- =========================================================
-- INIT — dipanggil dari main.lua dengan Fly module
-- =========================================================
function UI.init(Fly)
    ...
    speedVal.Text                  = tostring(Fly.speed)
    ...
    fill.Size             = UDim2.new((Fly.speed - 1) / 499, 0, 1, 0)
    ...
    thumb.Position         = UDim2.new((Fly.speed - 1) / 499, 0, 0.5, 0)
    ...
    -- =========================================================
    -- TOGGLE FLY (pakai Fly module dari main.lua)
    -- =========================================================
    ...
    local function updateSlider(posX)
        ...
        Fly.speed      = math.floor(1 + rel * 499)
        speedVal.Text  = tostring(Fly.speed)
